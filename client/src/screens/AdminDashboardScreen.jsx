                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setArticlePublicPages(Number(e.target.value))}
                      className="w-full px-3 py-2 border rounded"
                      required
                    />
                  </div>
                  ...
                  >
                    {isCreatingArticle || isUploading ? 'Processing...' : 'Create Article'}
                  </button>
                </form>
            ...
            {activeTab === 'siteContent' &&
              (isLoadingSettings ? (
                ...
                >
                  ...
                  >
                    {isUpdatingSettings || isUploading ? 'Saving...' : 'Save All Text Changes'}
                  </button>
                </form>
              ))}
            {/* Footer Links Tab */}
