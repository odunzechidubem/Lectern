...
const userSchema = mongoose.Schema({
  ...
  role: { type: String, required: true, enum: ['student', 'lecturer', 'superAdmin'], default: 'student' },
...
userSchema.methods.createEmailChangeToken = function () { const changeToken = crypto.randomBytes(32).toString('hex'); this.emailChangeToken = crypto.createHash('sha256').update(changeToken).digest('hex'); this.emailChangeTokenExpires = Date.now() + 10 * 60 * 1000; return changeToken; };
